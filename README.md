...
# Installation
You can download the more recent releases from [modrinth](https://modrinth.com/mod/name-history-viewer)
Alternatively, this mod can be self compiled by running the standard `gradlew build` command.
